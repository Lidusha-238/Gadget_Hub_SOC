<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechWorld.aspx.cs" Inherits="Gadget_Hub.TechWorld" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tech World Distributor Dashboard</title>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            <div class="row flex-nowrap">
                ...
                <!-- Sidebar -->
                <div class="col-auto col-md-3 col-xl-2 px-3 sidebar d-flex flex-column align-items-start">
                    <h3>Tech World</h3>
                        ...
                        <asp:View ID="vwSentQuotations" runat="server">
                            <div class="main-content">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-3">
                                        <asp:TextBox ID="txtOrderID" runat="server" CssClass="form-control" Placeholder="Order ID (e.g., ORD1234)"></asp:TextBox>
