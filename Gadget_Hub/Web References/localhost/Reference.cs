...
namespace Gadget_Hub.localhost {
    ...
    public partial class UserService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public UserService() {
            this.Url = global::Gadget_Hub.Properties.Settings.Default.Gadget_Hub_localhost_UserService;
        ...
        /// <remarks/>
        public void RegisterUserAsync(string fullName, string email, string password, string phoneNumber) {
            this.RegisterUserAsync(fullName, email, password, phoneNumber, null);
        }
        
        /// <remarks/>
        public void RegisterUserAsync(string fullName, string email, string password, string phoneNumber, object userState) {
            ...
            this.InvokeAsync("RegisterUser", new object[] {
                        ...
                        email,
                        password,
                        phoneNumber}, this.RegisterUserOperationCompleted, userState);
        }
